...
1. Clone this
`git clone https://github.com/afonsoingles/printer`
2. Run UV
`uv sync`
3. Set the envs!
...
### Dashboard
I suppose no one wants to call API endpoints for a thing that should have a dashboard. [So I built one](https:/printer.afonsoingles.dev/), using AI. As i explained in the [dashboard's repo](https://github.com/afonsoingles/printer-dashboard), I'm more of a backend-dev, but i felt that this needed a dashboard. As i don't like to build websites, i let Amp do it with my supervision. I hope that it still is enjoyable experience and that it meets some high-level expectations
